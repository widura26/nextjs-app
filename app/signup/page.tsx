    ...
    return (
        <main className='flex flex-col h-screen bg-[#252525]'>
            <div className="w-[400px] flex flex-col gap-4 h-auto m-auto p-4">
                <div className="">
                    <h1 className='text-white font-bold text-[20px] text-center'>SIGN UP</h1>
                </div>
                <div>
                    <label htmlFor="name" className="block text-sm/6 font-medium text-white">Name</label>
                    <div className="mt-2">
                        <input id="name" placeholder="Name" type="text" name="name" autoComplete="name" className="block w-full rounded-md bg-[#252525] px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    </div>
                </div>
                <div>
                ...
                <div>
                    <button className="text-white bg-[#646464] rounded-lg p-2 w-full active:bg-[#4b4b4b] hover:bg-[#4b4b4b]">Sign up</button>
                </div>
                <div className="flex justify-center">
                    <p className='text-white text-[12px]'>already have account? <Link href="/login" className='text-[#187cff]'>sign in</Link></p>
                </div>
                <div className="flex justify-center">
